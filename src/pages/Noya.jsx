      ...
      <section className="mt-12">
        <div className="container flex flex-col gap-12">
          <div className="relative">
            <img src="/images/noya/6.jpg" alt="" />
            <div className="absolute inset-0 w-full h-full z-50 flex flex-col justify-center items-center gap-[50px] p-5">
          ...
          <div className="relative">
            <img src="/images/noya/7.jpg" alt="" />
            <div className="absolute inset-0 w-full h-full z-50 flex flex-col justify-end items-center gap-[50px] p-5">
              <h2 className="text-white text-[24px] leading-[32px] sm:text-[40px] sm:leading-[44px] font-semibold">
                Bobo Choses
              </h2>
              <div className="mb-11">
